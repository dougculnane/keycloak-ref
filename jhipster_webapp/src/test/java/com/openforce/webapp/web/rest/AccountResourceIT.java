package com.openforce.webapp.web.rest;

import com.openforce.webapp.JhipsterWebappApp;
import com.openforce.webapp.config.TestSecurityConfiguration;
import com.openforce.webapp.security.AuthoritiesConstants;
import com.openforce.webapp.service.UserService;
import com.openforce.webapp.web.rest.errors.ExceptionTranslator;
 ...
 */
@SpringBootTest(classes = {JhipsterWebappApp.class, TestSecurityConfiguration.class})
